...
function Navbar() {
  ...
  return (
    <nav className="bg-repower-dark-blue fixed left-0 right-0 top-0 z-50 px-6 py-4 text-white">
      <div className="flex flex-wrap items-center justify-items-center md:flex-nowrap">
        ...
        <div
          ...
          role="presentation"
        >
          <ul className="flex flex-col justify-end gap-x-8 gap-y-4 text-nowrap text-center text-lg md:flex-row [&>li:hover]:text-gray-300 [&>li]:inline-block">
